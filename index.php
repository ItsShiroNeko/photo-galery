...
$welcome = mysqli_query($conn, "SELECT username FROM users WHERE id = '$user_id';");
$a = mysqli_fetch_assoc($welcome)
...
<body>
    ...
    <div class="container mt-4">
        <h2 class="text text-sm">Selamat Datang <?php echo $a['username'] ?>!</h2>
        <br>
        <?php
        if (isset($_SESSION['user_id'])) {
            $user_id = $_SESSION['user_id'];
            ...
            echo '<p>Silahkan login atau register untuk dapat melihat album!</p>';
        }
        ?>
    </div>
</body>
